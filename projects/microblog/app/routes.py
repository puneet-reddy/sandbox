...
def login():
    '''The login page for the microblog app'''
...
@login_required
def index():
    '''The home page for the microblog app'''
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            flash('{} is not a registered email'.format(form.email.data))
        return redirect(url_for('login'))
